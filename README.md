...
- **الموقع المنشور**: https://malaf.pro — مربوط بـ GitHub (`lawyer-m-hosainy/malaf-landing`)، أي push على `main` بيتنشر تلقائياً. لو ربطت دومين خاص، غيّر الروابط المطلقة في `index.html` (canonical + og:url + og:image).
