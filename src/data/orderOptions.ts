...
export const PACKAGES = [
  { key: 'basic', label: 'عرض الإطلاق — 500 ج.م (موقع تعريفي، 3 أيام عمل)' },
  { key: 'pro', label: 'المحامي المحترف — 1,200 ج.م (متعدد الصفحات + مدونة)' },
  { key: 'vip', label: 'المكتب المتكامل — 2,500 ج.م (حتى 10 صفحات + حجز مواعيد)' },
] as const;
